...
class CryptoExchangesList(BaseModel):
    """
    A list of cryptocurrency exchanges
    """ # noqa: E501
    items: List[CryptoExchangeItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CryptoExchangeItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
