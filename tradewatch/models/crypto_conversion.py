...
class CryptoConversion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["info", "query", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "info": ConversionInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
            "query": CryptoConversionQuery.from_dict(obj["query"]) if obj.get("query") is not None else None,
