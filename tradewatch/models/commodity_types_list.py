...
class CommodityTypesList(BaseModel):
    """
    A list of commodity types
    """ # noqa: E501
    items: List[CommodityTypeObj]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CommodityTypeObj.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
