...
class CryptoApi:
    ...
    def _convert_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/crypto/convert/{from}/{to}',
    ...
    def crypto_get_exchanges_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CryptoExchangesList]:
        """Available Exchanges
    ...
    def _crypto_get_exchanges_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/crypto/exchanges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _getQuote_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/crypto/symbols/{symbol}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
