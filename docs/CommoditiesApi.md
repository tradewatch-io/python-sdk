...
with tradewatch.ApiClient(configuration) as api_client:
    ...
    api_instance = tradewatch.CommoditiesApi(api_client)
    ...
    try:
        ...
        print("The response of CommoditiesApi->getQuote:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommoditiesApi->getQuote: %s\n" % e)
```
...
# **getSymbols**
> CursorPageTCustomizedSymbolsOutFull getSymbols(mode, size=size, type=type, page=page, cursor=cursor)
...
with tradewatch.ApiClient(configuration) as api_client:
    ...
    type = tradewatch.CommodityType() # CommodityType |  (optional)
    page = 1 # int | Page number (optional) (default to 1)
    cursor = 'cursor_example' # str | Cursor for the next page (optional)

    try:
        # Available Symbols
        api_response = api_instance.getSymbols(mode, size=size, type=type, page=page, cursor=cursor)
        print("The response of CommoditiesApi->getSymbols:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommoditiesApi->getSymbols: %s\n" % e)
```
...
with tradewatch.ApiClient(configuration) as api_client:
    ...
    try:
        # Available Types
        api_response = api_instance.getTypes()
        print("The response of CommoditiesApi->getTypes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CommoditiesApi->getTypes: %s\n" % e)
```
